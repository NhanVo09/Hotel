...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>CẦN THƠ HOTEL,</p>
				<p>01 Đường 3 Tháng 2,<br>Quận Ninh Kiều,<br>Thành phố Cần Thơ.</p>
				<p>0292.2222.600</p>
			</address>
		...
		<article>
			...
			<table class="meta">
				...
				<tr>
					<th><span >Ngày lập hóa đơn</span></th>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr>
						...
						<td><span ><?php echo $days; ?></span></td>
						<td><span data-prefix></span><span ><?php  echo $type_of_bed*1000 ;?>VND</span></td>
						<td><span ><?php echo $nroom;?> </span></td>
						<td><span data-prefix></span><span><?php echo $btot*1000 ; ?></span>VND</td>
					</tr>
					<tr>
						<td><span ><?php echo $meal; ?>  </span></td>
						<td><span ><?php echo $days; ?></span></td>
						<td><span data-prefix></span><span ><?php  echo $type_of_meal*1000 ;?></span>VND</td>
						<td><span ><?php echo $nroom;?> </span></td>
						<td><span data-prefix></span><span><?php echo $mepr*1000 ; ?></span>VND</td>
					</tr>
				</tbody>
			</table>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix></span><span><?php echo $fintot*1000 ; ?></span>VND</td>
				</tr>
				<tr>
					<th><span >Đã Thanh Toán</span></th>
					<td><span data-prefix></span><span >0</span>VND</td>
				</tr>
				<tr>
					<th><span >Chưa Thanh toán</span></th>
					<td><span data-prefix></span><span><?php echo $fintot*1000 ; ?></span>VND</td>
				</tr>
			</table>
		</article>
		<aside>
			...
			<div >
				<p align="center">Email :- canthohotel@gmail.com || Web :- www.canthohotel.com || Phone :- 0292.2222.600 </p>
			</div>
		</aside>
	</body>
</html>
